...
from dataset.flow_blur_dataset import Flow_Blur_dataset
...
if "__main__" == __name__:
    ...
    parser.add_argument(
        "--output_dir", type=str, default='output/M+V->G_Raw', help="directory to save checkpoints"
    )
    ...
    model = B2FPipeline.from_pretrained(
